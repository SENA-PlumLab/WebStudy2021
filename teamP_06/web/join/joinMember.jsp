...
<link href="join_css.css?ver=1" rel="stylesheet" type="text/css">
...
function openWindowPop(url, name){
    var options = 'top=10, left=10, width=500px, height=300px, status=no, menubar=no, toolbar=no, resizable=no';
