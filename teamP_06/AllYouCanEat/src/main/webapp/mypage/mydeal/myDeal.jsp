...
<body>
	...
	String [] image = {"/AllYouCanEat/mypage/mydeal/image_food/domino.jpg"};
	%>
	<section>
		<div class="wrap">
			<article>
					...
					<div class="mydeal_available">
						...
						<div class="mydeal_available_list">
							...
							<div class="available_list_box">
								<div class="available_thumbnail"><img id="available_thumb" src="<%=image[0]%>"></div>
